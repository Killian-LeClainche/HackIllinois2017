...
public class Classification
{
	...
	/**
	 * Creates a Classification Object by reading the contents inside a folder
	 * and produces the appropriate input node vales.
	 * 
	 * @param classFolder
	 *            : The folder whose contents (sub files) shall be read and
	 *            converted
	 * @return The Classification Object.
	 * @throws IOException
	 *             : thrown when IO reading produces an error.
	 */
	...
	/**
	 * @param index
	 *            : returns the image data associated with the particular index.
	 * @return
	 */
