...
public class SamplePool 
{
	...
	/**
	 * Generates the Sample Pool from a given image folder that the system will read through and generate the data.
	 * @param imageFolder : Main folder that contains all the classifications.
	 * @return A Sample Pool Object for use.
	 * @throws IOException : thrown when an Image cannot be properly read.
	 */
	...
	/**
	 * Custom Random object that will be used to obtain a generations sample pool.
	 */
	 ...
	 * @param names : All the classifications to be used.
	 */
	...
	{
		//Create variables, one which is the classification sample, the other is the random pool of samples inside it.
		...
		//Clone all the data from the classification into a new array to prevent any base edits to the sample data.
