...
/**
 * Neural network is a layer of input neuron connected to a hidden layer that
 * outputs to a output layer. Mutated version of the network can be generated by
 * taking the genome and altering it.
 * 
 * It creates a neural network from a genome and will generate the same network
 * given the same ini file and genome.
 *
 * @author Jarett Lee
 */
public class NeuralNetwork
{
	...
	/*
	 * public static void main(String args[]) { NeuralNetwork seed = new
	 * NeuralNetwork(); NeuralNetwork n1 = new NeuralNetwork(seed.getGenome());
	 * NeuralNetwork n2 = new NeuralNetwork(n1.getGenome()); List<Double> d1 =
	 * n1.getGenome().weights; List<Double> d2 = n2.getGenome().weights;
	 * Iterator<Double> i1 = d1.iterator(); Iterator<Double> i2 = d2.iterator();
	 * int count = 0; while (i1.hasNext() && i2.hasNext()) { Double val1 =
	 * i1.next(); Double val2 = i2.next();
	 * 
	 * if (!val1.equals(val2)) { System.out.println(count + "\t" + val1 + "\t" +
	 * val2); } count++; } System.out.println("Size: " + d1.size() + " " +
	 * d2.size()); System.out.println("Equal: " + d1.equals(d2)); }
	 */
}
