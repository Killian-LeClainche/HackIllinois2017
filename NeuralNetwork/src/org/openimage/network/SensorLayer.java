...
public class SensorLayer extends Layer
{
	...
	/*
	 * public SensorLayer(int size) { nodes = new ArrayList<Node>(size);
	 * 
	 * for (int i = 0; i < size; i++) { Sensor sensor = new Sensor();
	 * nodes.add(sensor); }
	 * 
	 * }
	 * 
	 * public SensorLayer(List<Node> inputs) { for (Node node : inputs) { if ())
	 * } }
	 * 
	 * public
	 */
